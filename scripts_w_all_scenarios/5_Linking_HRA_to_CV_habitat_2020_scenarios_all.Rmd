...
hab_risk <-raster("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016/outputs/RECLASS_RISK_corals.tif")
reclass_df <- c(0, 1,
                1, 1,
                2, 2,
                3, 4)
...
coral_w_barrier <-raster("E:/GreenFin/02_cv_model/hra_cv_linkages/corals_2020_w_barrier_500m.tif")
...
writeRaster(hab_risk_reclassified_nearshore, filename=file.path("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_2016_corals_nearshore.tif"), format="GTiff", overwrite=TRUE)
writeRaster(hab_risk_reclassified_barrier, filename=file.path("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_2016_corals_barrier.tif"), format="GTiff", overwrite=TRUE)
```
...
hab_risk <-raster("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016/outputs/RECLASS_RISK_seagrass.tif")
reclass_df <- c(0, 4,
                1, 4,
                2, 4.5,
                3, 5)
...
hab_risk_reclassified <- reclassify(hab_risk,
                             reclass_m)
plot(hab_risk_reclassified)
writeRaster(hab_risk_reclassified, filename=file.path("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_2016_seagrass.tif"), format="GTiff", overwrite=TRUE)
```
...
```{r Reclassify risk levels into habitat protective values and export as rasters}
hab_risk <-raster("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016/outputs/RECLASS_RISK_mangroves.tif")
reclass_df <- c(0, 1,
                1, 1,
                2, 2,
                3, 5)
...
hab_risk_reclassified <- reclassify(hab_risk,
                                         reclass_m)
plot(hab_risk_reclassified)
writeRaster(hab_risk_reclassified, filename=file.path("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_2016_mangroves.tif"), format="GTiff", overwrite=TRUE)
```
...
hra_cv_hab_ranks_fors <-raster("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_forest.tif")
hra_cv_hab_ranks_mang <-raster("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_2016_mangroves.tif")
hra_cv_hab_ranks_seag <-raster("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_2016_seagrass.tif")
hra_cv_hab_ranks_corf <-raster("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_2016_corals_nearshore.tif")
hra_cv_hab_ranks_corb <-raster("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_2016_corals_barrier.tif")
```
...
cv_data_sp <- as(cv_data, "Spatial")
class(cv_data_sp)
writeOGR(obj=cv_data_sp, dsn="E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2016", layer="cv_hab_protect_values_w_hra", driver="ESRI Shapefile", overwrite_layer =  T)
cv_data_df <- as.data.frame(cv_data_sp)
names(cv_data_df)
cv_data_df <- cv_data_df[,-c(17:18)] 
write.csv(cv_data_df, file.path("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2016", paste("cv_hab_protect_values_w_hra.csv")), row.names = F)
```
...
cv_data <- st_read("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2016/cv_hab_protect_values_w_hra.shp")
...
write.csv(cv_data_hab_rank, file.path("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2016", paste("cv_hab_rank_w_hra.csv")), row.names = F)
```
...
cv_data_sp <- as(cv_data, "Spatial")
class(cv_data_sp)
writeOGR(obj=cv_data_sp, dsn="E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2016", layer="cv_hab_rank_w_hra", driver="ESRI Shapefile", overwrite_layer =  T)
```
...
write.csv(cv_data, file.path("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2016", paste("cv_ei_w_hra.csv")), row.names = F)
cv_data_sp <- as(cv_data, "Spatial")
class(cv_data_sp)
writeOGR(obj=cv_data_sp, dsn="E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2016", layer="cv_ei_w_hra", driver="ESRI Shapefile", overwrite_layer =  T)
```
...
```{r Reclassify risk levels into habitat protective values}
hab_risk <-raster("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020/outputs/RECLASS_RISK_corals.tif")
reclass_df <- c(0, 1,
                1, 1,
                2, 2,
                3, 4)
...
hab_risk_reclassified_barrier[coral_w_barrier<2] <- NA
plot(hab_risk_reclassified_barrier)
writeRaster(hab_risk_reclassified_nearshore, filename=file.path("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_2020_corals_nearshore.tif"), format="GTiff", overwrite=TRUE)
writeRaster(hab_risk_reclassified_barrier, filename=file.path("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_2020_corals_barrier.tif"), format="GTiff", overwrite=TRUE)
```

## 2/ Seagrass habitat
These codes will create a map with habitat protective values based on a classification matrix and habitat risk values for the seagrass habitat.
```{r Reclassify risk levels into habitat protective values and export as rasters}
hab_risk <-raster("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020/outputs/RECLASS_RISK_seagrass.tif")
reclass_df <- c(0, 4,
                1, 4,
                2, 4.5,
                3, 5)
...
hab_risk_reclassified <- reclassify(hab_risk,
                             reclass_m)
plot(hab_risk_reclassified)
writeRaster(hab_risk_reclassified, filename=file.path("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_2020_seagrass.tif"), format="GTiff", overwrite=TRUE)
```

## 3/ Mangroves habitat
These codes will create a map with habitat protective values based on a classification matrix and habitat risk values for the mangroves habita:
```{r Reclassify risk levels into habitat protective values and export as rasters}
hab_risk <-raster("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020/outputs/RECLASS_RISK_mangroves.tif")
reclass_df <- c(0, 1,
                1, 1,
                2, 2,
                3, 5)
...
hab_risk_reclassified <- reclassify(hab_risk,
                                         reclass_m)
plot(hab_risk_reclassified)
writeRaster(hab_risk_reclassified, filename=file.path("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_2020_mangroves.tif"), format="GTiff", overwrite=TRUE)
```
...
```{r Import the rasters with the habitat protective values}
hra_cv_hab_ranks_fors <-raster("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_forest.tif")
hra_cv_hab_ranks_mang <-raster("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_2020_mangroves.tif")
hra_cv_hab_ranks_seag <-raster("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_2020_seagrass.tif")
hra_cv_hab_ranks_corf <-raster("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_2020_corals_nearshore.tif")
hra_cv_hab_ranks_corb <-raster("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_2020_corals_barrier.tif")
```
...
cv_data_sp <- as(cv_data, "Spatial")
class(cv_data_sp)
writeOGR(obj=cv_data_sp, dsn="E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2020", layer="cv_hab_protect_values_w_hra", driver="ESRI Shapefile", overwrite_layer =  T)
cv_data_df <- as.data.frame(cv_data_sp)
names(cv_data_df)
cv_data_df <- cv_data_df[,-c(18:19)] 
write.csv(cv_data_df, file.path("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2020", paste("cv_hab_protect_values_w_hra.csv")), row.names = F)
```
...
To do so, we need to import cv variables to compute the new habitat rank 
```{r Import the shp with the new habitat protective values}
cv_data <- st_read("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2020/cv_hab_protect_values_w_hra.shp")
cv_data_hab_rank <- as.data.frame(cv_data)
names(cv_data_hab_rank)
```
...
Write the csv file
```{r Export csv results}
write.csv(cv_data_hab_rank, file.path("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2020", paste("cv_hab_rank_w_hra.csv")), row.names = F)
```
...
cv_data_sp <- as(cv_data, "Spatial")
class(cv_data_sp)
writeOGR(obj=cv_data_sp, dsn="E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2020", layer="cv_hab_rank_w_hra", driver="ESRI Shapefile", overwrite_layer =  T)
```
...
Write the results in a shp and csv formats:
```{r Export results as shp and csv}
write.csv(cv_data, file.path("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2020", paste("cv_ei_w_hra.csv")), row.names = F)
cv_data_sp <- as(cv_data, "Spatial")
class(cv_data_sp)
writeOGR(obj=cv_data_sp, dsn="E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2020", layer="cv_ei_w_hra", driver="ESRI Shapefile", overwrite_layer =  T)
```
...
```{r Reclassify risk levels into habitat protective values}
hab_risk <-raster("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025/outputs/RECLASS_RISK_corals.tif")
reclass_df <- c(0, 1,
                1, 1,
                2, 2,
                3, 4)
...
hab_risk_reclassified_barrier[coral_w_barrier<2] <- NA
plot(hab_risk_reclassified_barrier)
writeRaster(hab_risk_reclassified_nearshore, filename=file.path("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_2025_corals_nearshore.tif"), format="GTiff", overwrite=TRUE)
writeRaster(hab_risk_reclassified_barrier, filename=file.path("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_2025_corals_barrier.tif"), format="GTiff", overwrite=TRUE)
```

## 2/ Seagrass habitat
These codes will create a map with habitat protective values based on a classification matrix and habitat risk values for the seagrass habitat.
```{r Reclassify risk levels into habitat protective values and export as rasters}
hab_risk <-raster("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025/outputs/RECLASS_RISK_seagrass.tif")
reclass_df <- c(0, 4,
                1, 4,
                2, 4.5,
                3, 5)
...
hab_risk_reclassified <- reclassify(hab_risk,
                             reclass_m)
plot(hab_risk_reclassified)
writeRaster(hab_risk_reclassified, filename=file.path("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_2025_seagrass.tif"), format="GTiff", overwrite=TRUE)
```

## 3/ Mangroves habitat
These codes will create a map with habitat protective values based on a classification matrix and habitat risk values for the mangroves habita:
```{r Reclassify risk levels into habitat protective values and export as rasters}
hab_risk <-raster("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025/outputs/RECLASS_RISK_mangroves.tif")
reclass_df <- c(0, 1,
                1, 1,
                2, 2,
                3, 5)
...
hab_risk_reclassified <- reclassify(hab_risk,
                                         reclass_m)
plot(hab_risk_reclassified)
writeRaster(hab_risk_reclassified, filename=file.path("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_2025_mangroves.tif"), format="GTiff", overwrite=TRUE)
```
...
```{r Import the rasters with the habitat protective values}
hra_cv_hab_ranks_fors <-raster("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_forest.tif")
hra_cv_hab_ranks_mang <-raster("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_2025_mangroves.tif")
hra_cv_hab_ranks_seag <-raster("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_2025_seagrass.tif")
hra_cv_hab_ranks_corf <-raster("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_2025_corals_nearshore.tif")
hra_cv_hab_ranks_corb <-raster("E:/GreenFin/02_cv_model/hra_data/2020_habitats/cv_ranks_2025_corals_barrier.tif")
```
...
cv_data_sp <- as(cv_data, "Spatial")
class(cv_data_sp)
writeOGR(obj=cv_data_sp, dsn="E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2025", layer="cv_hab_protect_values_w_hra", driver="ESRI Shapefile", overwrite_layer =  T)
cv_data_df <- as.data.frame(cv_data_sp)
names(cv_data_df)
cv_data_df <- cv_data_df[,-c(18:19)] 
write.csv(cv_data_df, file.path("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2025", paste("cv_hab_protect_values_w_hra.csv")), row.names = F)
```
...
To do so, we need to import cv variables to compute the new habitat rank 
```{r Import the shp with the new habitat protective values}
cv_data <- st_read("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2025/cv_hab_protect_values_w_hra.shp")
cv_data_hab_rank <- as.data.frame(cv_data)
names(cv_data_hab_rank)
```
...
Write the csv file
```{r Export csv results}
write.csv(cv_data_hab_rank, file.path("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2025", paste("cv_hab_rank_w_hra.csv")), row.names = F)
```
...
cv_data_sp <- as(cv_data, "Spatial")
class(cv_data_sp)
writeOGR(obj=cv_data_sp, dsn="E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2025", layer="cv_hab_rank_w_hra", driver="ESRI Shapefile", overwrite_layer =  T)
```
...
Write the results in a shp and csv formats:
```{r Export results as shp and csv}
write.csv(cv_data, file.path("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2025", paste("cv_ei_w_hra.csv")), row.names = F)
cv_data_sp <- as(cv_data, "Spatial")
class(cv_data_sp)
writeOGR(obj=cv_data_sp, dsn="E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2025", layer="cv_ei_w_hra", driver="ESRI Shapefile", overwrite_layer =  T)
```
...
cv_2016 <- st_read("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2016/cv_ei_w_hra.shp")
names(cv_2016)
...
cv_2020 <- st_read("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2020/cv_ei_w_hra.shp")
names(cv_2020)
...
cv_2025 <- st_read("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2025/cv_ei_w_hra.shp")
names(cv_2025)
...
class(cv_2016_sp)
writeOGR(obj=cv_2016_sp, dsn="E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2016/", layer="cv_2016_ei_reclass", driver="ESRI Shapefile", overwrite_layer =  T)
cv_2016_df <- as.data.frame(cv_2016_sp)
names(cv_2016_df)
cv_2016_df <- cv_2016_df[,-c(28:29)]# delete coord
names(cv_2016_df)
write.csv(cv_2016_df, paste0("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2016/", "cv_2016_ei_reclass.csv"), row.names = F)
```

```{r Export 2020 results as shp and csv}
cv_2020_sp <- as(cv_2020, "Spatial")
class(cv_2020_sp)
writeOGR(obj=cv_2020_sp, dsn="E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2020/", layer="cv_2020_ei_reclass", driver="ESRI Shapefile", overwrite_layer =  T)
cv_2020_df <- as.data.frame(cv_2020_sp)
names(cv_2020_df)
cv_2020_df <- cv_2020_df[,-c(28:29)]# delete coord
names(cv_2020_df)
write.csv(cv_2020_df, paste0("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2020/", "cv_2020_ei_reclass.csv"), row.names = F)
```

```{r Export 2025 results as shp and csv}
cv_2025_sp <- as(cv_2025, "Spatial")
class(cv_2025_sp)
writeOGR(obj=cv_2025_sp, dsn="E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2025/", layer="cv_2025_ei_reclass", driver="ESRI Shapefile", overwrite_layer =  T)
cv_2025_df <- as.data.frame(cv_2025_sp)
names(cv_2020_df)
cv_2025_df <- cv_2025_df[,-c(28:29)]# delete coord
names(cv_2025_df)
write.csv(cv_2025_df, paste0("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2025/", "cv_2025_ei_reclass.csv"), row.names = F)
```
...
cv_2016_ei_reclass_cpu <- read.csv("E:/Greenfin/02_cv_model/cv_outputs/2020_habitats/2016/cv_2016_ei_reclass.csv")
...
cv_2016_ei_reclass_cpu_count <- cv_2016_ei_reclass_cpu [,c(1,12,27)]
...
target <- c('high')
cv_2016_shoreline_km_high <- cv_2016_shoreline_km[cv_2016_shoreline_km$ei_class %in% target,] 
write.csv(cv_2016_shoreline_km, paste0("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2016/", "cv_2016_ei_reclass_count.csv"), row.names = F)
write.csv(cv_2016_shoreline_km_high, paste0("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2016/", "cv_2016_ei_reclass_count_high.csv"), row.names = F)
```

Do the same for 2020
```{r Count the number of shoreline points with high coastal risk in 2020}
cv_2020_ei_reclass_cpu <- read.csv("E:/Greenfin/02_cv_model/cv_outputs/2020_habitats/2020/cv_2020_ei_reclass.csv")
...
cv_2020_ei_reclass_cpu_count <- cv_2020_ei_reclass_cpu [,c(1,12,27)]
...
target <- c('high')
cv_2020_shoreline_km_high <- cv_2020_shoreline_km[cv_2020_shoreline_km$ei_class %in% target,] 
write.csv(cv_2020_shoreline_km, paste0("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2020/", "cv_2020_ei_reclass_count.csv"), row.names = F)
write.csv(cv_2020_shoreline_km_high, paste0("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2020/", "cv_2020_ei_reclass_count_high.csv"), row.names = F)
```

And 2025
```{r Count the number of shoreline points with high coastal risk in 2025}
cv_2025_ei_reclass_cpu <- read.csv("E:/Greenfin/02_cv_model/cv_outputs/2020_habitats/2025/cv_2025_ei_reclass.csv")
...
cv_2025_ei_reclass_cpu_count <- cv_2025_ei_reclass_cpu [,c(1,12,27)]
...
target <- c('high')
cv_2025_shoreline_km_high <- cv_2025_shoreline_km[cv_2025_shoreline_km$ei_class %in% target,]
write.csv(cv_2025_shoreline_km, paste0("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2025/", "cv_2025_ei_reclass_count.csv"), row.names = F)
write.csv(cv_2025_shoreline_km_high, paste0("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/2025/", "cv_2025_ei_reclass_count_high.csv"), row.names = F)
```
...
write.csv(cv_shoreline_km_high, paste0("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/", "cv_ei_reclass_count_high.csv"), row.names = F)
```

# Summarize the results into bar charts:

```{r attach the CPU names to the CV results}
cv_outputs <- read.csv("E:/Greenfin/02_cv_model/cv_outputs/2020_habitats/cv_ei_reclass_count_high.csv")
CPU_shp <- st_read("E:/Greenfin/_data/base_layers/cp_regions_3km_buffer.shp")
CPU_df <- as.data.frame(CPU_shp)
CPU_df$cpu <- as.factor(CPU_df$cpu)
CPU_df$cpu_name <- as.factor(CPU_df$cpu_name)
CPU_df$cpu <- CPU_df$cpu
CPU_df$cpuwname <- paste(CPU_df$cpu,CPU_df$cpu_name,sep= "-")
cpu_info <- CPU_df[,c(1,5)]
cv_outputs <- cbind(cv_outputs,cpu_info, by="cpu")
cv_outputs <- cv_outputs[,-c(6,8)]
write.csv(cv_outputs, paste0("E:/GreenFin/02_cv_model/cv_outputs/2020_habitats/", "cv_ei_reclass_count_high.csv"), row.names = F)
```

Create bar chart on Coastal Risk Exposure by CPU & add names to the Coastal Planning Unit
```{r Build bar chart with km of shoreline protected by CPU}
cv_outputs <- read.csv("E:/Greenfin/02_cv_model/cv_outputs/2020_habitats/cv_ei_reclass_count_high.csv")
# add a column
...
pdf(file.path("E:/Greenfin/02_cv_model/cv_outputs/2020_habitats", paste("_barplot_cpu_cv_high_ei_km.pdf")),
    width = 8, height = 5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
