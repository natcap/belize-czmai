---
title: "Converting the outputs from HRA to inputs in the Recreation model using the habitat maps from 2016- Scenario 2020"
...
# A/ Create shapefiles of habitat risk maps (No|Low and Medium risk maps) based on the 2020 Human stressors:
...
# B/ Calculate the functional habitat per habitat for the human stressors from 2020:
...
## B.1/ Calculate the functional habitat for the Coral habitat from 2016 and human stressors from 2020
...
## B.2/ Calculate the functional habitat for the Seagrass habitat from 2016 and human stressors from 2020
...
## B.3/ Calculate the functional habitat for the Mangroves habitat from 2016 and human stressors from 2020
...
# C/ Rasterize functional habitat predictors for human stressors 2020
