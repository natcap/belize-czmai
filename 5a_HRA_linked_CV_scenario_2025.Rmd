---
title: "Converting the outputs from HRA to inputs in the Coastal Vulnerability model using the habitat maps from 2016 ~ Stressors 2025"
...
# D.1/ Quantify the habitat importance at protecting the coastaline for all the scenarios (2016, 2020, 2025) relative to the 2016 No Habitat EI:
...
cv_all_scenarios <- rbind (scenario_stack_1, scenario_stack_2, scenario_stack_3, scenario_stack_4)
...
# D.2/ Summarize the # of km and people benefit from coastal habitat protection for all the scenarios (2016, 2020, 2025) by coastal planning units:
...
## D.2.1/ Change in risk exposure class due to habitat 
...
## D.2.2/ Change in high risk exposure due to habitat 
...
# D.3/ Summarize the results into bar charts:
