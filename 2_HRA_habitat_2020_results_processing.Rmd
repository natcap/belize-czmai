...
# A/ 2020 Habitat maps & 2016 Human stressors:
...
reclass_risk_corals <- raster("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016/outputs/RECLASS_RISK_corals.tif")
risk_corals_none <- reclass_risk_corals==0
plot(risk_corals_none)
writeRaster(risk_corals_none, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016/risk_none_corals.tif", overwrite=TRUE)
risk_corals_low <- reclass_risk_corals==1
plot(risk_corals_low)
writeRaster(risk_corals_low, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016/risk_low_corals.tif", overwrite=TRUE)
risk_corals_med <- reclass_risk_corals==2
plot(risk_corals_med)
writeRaster(risk_corals_med, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016/risk_med_corals.tif", overwrite=TRUE)
risk_corals_hig <- reclass_risk_corals==3
plot(risk_corals_hig)
writeRaster(risk_corals_hig, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016/risk_hig_corals.tif", overwrite=TRUE)
```
...
reclass_risk_seagrass <- raster("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016/outputs/RECLASS_RISK_seagrass.tif")
risk_seagrass_none <- reclass_risk_seagrass==0
plot(risk_seagrass_none)
writeRaster(risk_seagrass_none, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016/risk_none_seagrass.tif", overwrite=TRUE)
risk_seagrass_low <- reclass_risk_seagrass==1
plot(risk_seagrass_low)
writeRaster(risk_seagrass_low, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016/risk_low_seagrass.tif", overwrite=TRUE)
risk_seagrass_med <- reclass_risk_seagrass==2
plot(risk_seagrass_med)
writeRaster(risk_seagrass_med, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016/risk_med_seagrass.tif", overwrite=TRUE)
risk_seagrass_hig <- reclass_risk_seagrass==3
plot(risk_seagrass_hig)
writeRaster(risk_seagrass_hig, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016/risk_hig_seagrass.tif", overwrite=TRUE)
```
...
reclass_risk_mangroves <- raster("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016/outputs/RECLASS_RISK_mangroves.tif")
risk_mangroves_none <- reclass_risk_mangroves==0
plot(risk_mangroves_none)
writeRaster(risk_mangroves_none, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016/risk_none_mangroves.tif", overwrite=TRUE)
risk_mangroves_low <- reclass_risk_mangroves==1
plot(risk_mangroves_low)
writeRaster(risk_mangroves_low, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016/risk_low_mangroves.tif", overwrite=TRUE)
risk_mangroves_med <- reclass_risk_mangroves==2
plot(risk_mangroves_med)
writeRaster(risk_mangroves_med, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016/risk_med_mangroves.tif", overwrite=TRUE)
risk_mangroves_hig <- reclass_risk_mangroves==3
plot(risk_mangroves_hig)
writeRaster(risk_mangroves_hig, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016/risk_hig_mangroves.tif", overwrite=TRUE)
```

# B/ Habitat 2020 - Stressors 2016: Calculate the habitat area under each risk class per planning unit
...
corals <- st_read("E:/GreenFin/01_hra_model/_base/cpu_corals_2020.shp")
```
...
corals$non_pct <- round(corals$non_km2/corals$cpu_km2*100, digits = 1)
corals$low_pct <- round(corals$low_km2/corals$cpu_km2*100, digits = 1) 
corals$med_pct <- round(corals$med_km2/corals$cpu_km2*100, digits = 1) 
corals$hig_pct <- round(corals$hig_km2/corals$cpu_km2*100, digits = 1) 
```

We export the shapefile and convert it to a csv table.

```{r Export the shapefile}
corals_sp <- as(corals, "Spatial")
class(corals_sp)
writeOGR(obj=corals_sp, dsn="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016", layer="risk_summary_corals", driver="ESRI Shapefile", overwrite_layer =  T)
```

Add a row for the missing Coastal planning units & convert to dataframe: 
```{r Add rows for missing CPU}
# convert to dataframe
corals_risk_summary <- as.data.frame(corals_sp)
names(corals_risk_summary)
# create the missing row
cpu_missing_w_column <- corals_risk_summary[1,]
names(cpu_missing_w_column)
cpu_missing_w_column$cpu <- 1
cpu_missing_w_column$cpu_km2 <- 1425.55
cpu_missing_w_column$cpu_name <-'Northern Region'
cpu_missing_w_column$cpu_nameo <-'Northern'
cpu_missing_w_column$non_km2 <- 0
cpu_missing_w_column$low_km2 <- 0
cpu_missing_w_column$med_km2 <- 0
cpu_missing_w_column$hig_km2 <- 0
cpu_missing_w_column$non_pct <- 0
cpu_missing_w_column$low_pct <- 0
cpu_missing_w_column$med_pct <- 0
cpu_missing_w_column$hig_pct <- 0
corals_risk_summary <-  rbind(corals_risk_summary,cpu_missing_w_column)
# Write the csv file
write.csv(corals_risk_summary, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016", paste("risk_summary_corals.csv")), row.names = F)
```
...
seagrass <- st_read("E:/GreenFin/01_hra_model/_base/cpu_seagrass_2020.shp")
```
...
Then we convert the total km2 of habitat under different risk class into percent change from the total coastal planning unit area.
```{r Convert the km2 into percent change of the total plannig unit area}
seagrass$non_pct <- round(seagrass$non_km2/seagrass$cpu_km2*100, digits = 1)
seagrass$low_pct <- round(seagrass$low_km2/seagrass$cpu_km2*100, digits = 1) 
seagrass$med_pct <- round(seagrass$med_km2/seagrass$cpu_km2*100, digits = 1) 
seagrass$hig_pct <- round(seagrass$hig_km2/seagrass$cpu_km2*100, digits = 1) 
```
...
class(seagrass_sp)
writeOGR(obj=seagrass_sp, dsn="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016", layer="risk_summary_seagrass", driver="ESRI Shapefile", overwrite_layer =  T)
# convert to dataframe
seagrass_risk_summary <- as.data.frame(seagrass_sp)
names(seagrass_risk_summary)
# Write the csv file
write.csv(seagrass_risk_summary, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016", paste("risk_summary_seagrass.csv")), row.names = F)
```
...
mangroves <- st_read("E:/GreenFin/01_hra_model/_base/cpu_mangroves_2019.shp")
```
...
Then we convert the total km2 of habitat under different risk class into percent change from the total coastal planning unit area.
```{r Convert the km2 into percent change of the total plannig unit area}
mangroves$non_pct <- round(mangroves$non_km2/mangroves$cpu_km2*100, digits = 1)
mangroves$low_pct <- round(mangroves$low_km2/mangroves$cpu_km2*100, digits = 1) 
mangroves$med_pct <- round(mangroves$med_km2/mangroves$cpu_km2*100, digits = 1) 
mangroves$hig_pct <- round(mangroves$hig_km2/mangroves$cpu_km2*100, digits = 1) 
```
...
class(mangroves_sp)
writeOGR(obj=mangroves_sp, dsn="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016", layer="risk_summary_mangroves", driver="ESRI Shapefile", overwrite_layer =  T)
# convert to dataframe
mangroves_risk_summary <- as.data.frame(mangroves_sp)
names(mangroves_risk_summary)
# Write the csv file
write.csv(mangroves_risk_summary, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016", paste("risk_summary_mangroves.csv")), row.names = F)
```
...
# C/ Habitat 2020 - Stressors 2020: Create a map per habitat risk class
...
```{r Split the risk map for coral habitat into 3 seperate rasters}
reclass_risk_corals <- raster("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020/outputs/RECLASS_RISK_corals.tif")
risk_corals_none <- reclass_risk_corals==0
plot(risk_corals_none)
writeRaster(risk_corals_none, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020/risk_none_corals.tif", overwrite=TRUE)
risk_corals_low <- reclass_risk_corals==1
plot(risk_corals_low)
writeRaster(risk_corals_low, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020/risk_low_corals.tif", overwrite=TRUE)
risk_corals_med <- reclass_risk_corals==2
plot(risk_corals_med)
writeRaster(risk_corals_med, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020/risk_med_corals.tif", overwrite=TRUE)
risk_corals_hig <- reclass_risk_corals==3
plot(risk_corals_hig)
writeRaster(risk_corals_hig, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020/risk_hig_corals.tif", overwrite=TRUE)
```
...
```{r Split the risk map for seagrass habitat into 3 seperate rasters}
reclass_risk_seagrass <- raster("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020/outputs/RECLASS_RISK_seagrass.tif")
risk_seagrass_none <- reclass_risk_seagrass==0
plot(risk_seagrass_none)
writeRaster(risk_seagrass_none, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020/risk_none_seagrass.tif", overwrite=TRUE)
risk_seagrass_low <- reclass_risk_seagrass==1
plot(risk_seagrass_low)
writeRaster(risk_seagrass_low, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020/risk_low_seagrass.tif", overwrite=TRUE)
risk_seagrass_med <- reclass_risk_seagrass==2
plot(risk_seagrass_med)
writeRaster(risk_seagrass_med, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020/risk_med_seagrass.tif", overwrite=TRUE)
risk_seagrass_hig <- reclass_risk_seagrass==3
plot(risk_seagrass_hig)
writeRaster(risk_seagrass_hig, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020/risk_hig_seagrass.tif", overwrite=TRUE)
```
...
```{r Split the risk map for mangroves habitat into 3 seperate rasters}
reclass_risk_mangroves <- raster("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020/outputs/RECLASS_RISK_mangroves.tif")
risk_mangroves_none <- reclass_risk_mangroves==0
plot(risk_mangroves_none)
writeRaster(risk_mangroves_none, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020/risk_none_mangroves.tif", overwrite=TRUE)
risk_mangroves_low <- reclass_risk_mangroves==1
plot(risk_mangroves_low)
writeRaster(risk_mangroves_low, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020/risk_low_mangroves.tif", overwrite=TRUE)
risk_mangroves_med <- reclass_risk_mangroves==2
plot(risk_mangroves_med)
writeRaster(risk_mangroves_med, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020/risk_med_mangroves.tif", overwrite=TRUE)
risk_mangroves_hig <- reclass_risk_mangroves==3
plot(risk_mangroves_hig)
writeRaster(risk_mangroves_hig, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020/risk_hig_mangroves.tif", overwrite=TRUE)
```

# D/ Habitat 2020 - Stressors 2020: Calculate the habitat area under each risk class per planning unit
...
corals_sp <- as(corals, "Spatial")
class(corals_sp)
writeOGR(obj=corals_sp, dsn="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020", layer="risk_summary_corals", driver="ESRI Shapefile", overwrite_layer =  T)
```
...
corals_risk_summary <-  rbind(corals_risk_summary,cpu_missing_w_column)
# Write the csv file
write.csv(corals_risk_summary, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020", paste("risk_summary_corals.csv")), row.names = F)
```
...
seagrass_sp <- as(seagrass, "Spatial")
class(seagrass_sp)
writeOGR(obj=seagrass_sp, dsn="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020", layer="risk_summary_seagrass", driver="ESRI Shapefile", overwrite_layer =  T)
# convert to dataframe
seagrass_risk_summary <- as.data.frame(seagrass_sp)
names(seagrass_risk_summary)
# Write the csv file
write.csv(seagrass_risk_summary, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020", paste("risk_summary_seagrass.csv")), row.names = F)
```
...
mangroves_sp <- as(mangroves, "Spatial")
class(mangroves_sp)
writeOGR(obj=mangroves_sp, dsn="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020", layer="risk_summary_mangroves", driver="ESRI Shapefile", overwrite_layer =  T)
# convert to dataframe
mangroves_risk_summary <- as.data.frame(mangroves_sp)
names(mangroves_risk_summary)
# Write the csv file
write.csv(mangroves_risk_summary, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020", paste("risk_summary_mangroves.csv")), row.names = F)
```
...
# E/ Habitat 2020 - Stressors 2025: Create a map per habitat risk class
...
```{r Split the risk map for coral habitat into 3 seperate rasters}
reclass_risk_corals <- raster("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025/outputs/RECLASS_RISK_corals.tif")
risk_corals_none <- reclass_risk_corals==0
plot(risk_corals_none)
writeRaster(risk_corals_none, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025/risk_none_corals.tif", overwrite=TRUE)
risk_corals_low <- reclass_risk_corals==1
plot(risk_corals_low)
writeRaster(risk_corals_low, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025/risk_low_corals.tif", overwrite=TRUE)
risk_corals_med <- reclass_risk_corals==2
plot(risk_corals_med)
writeRaster(risk_corals_med, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025/risk_med_corals.tif", overwrite=TRUE)
risk_corals_hig <- reclass_risk_corals==3
plot(risk_corals_hig)
writeRaster(risk_corals_hig, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025/risk_hig_corals.tif", overwrite=TRUE)
```
...
```{r Split the risk map for seagrass habitat into 3 seperate rasters}
reclass_risk_seagrass <- raster("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025/outputs/RECLASS_RISK_seagrass.tif")
risk_seagrass_none <- reclass_risk_seagrass==0
plot(risk_seagrass_none)
writeRaster(risk_seagrass_none, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025/risk_none_seagrass.tif", overwrite=TRUE)
risk_seagrass_low <- reclass_risk_seagrass==1
plot(risk_seagrass_low)
writeRaster(risk_seagrass_low, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025/risk_low_seagrass.tif", overwrite=TRUE)
risk_seagrass_med <- reclass_risk_seagrass==2
plot(risk_seagrass_med)
writeRaster(risk_seagrass_med, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025/risk_med_seagrass.tif", overwrite=TRUE)
risk_seagrass_hig <- reclass_risk_seagrass==3
plot(risk_seagrass_hig)
writeRaster(risk_seagrass_hig, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025/risk_hig_seagrass.tif", overwrite=TRUE)
```
...
```{r Split the risk map for mangroves habitat into 3 seperate rasters}
reclass_risk_mangroves <- raster("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025/outputs/RECLASS_RISK_mangroves.tif")
risk_mangroves_none <- reclass_risk_mangroves==0
plot(risk_mangroves_none)
writeRaster(risk_mangroves_none, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025/risk_none_mangroves.tif", overwrite=TRUE)
risk_mangroves_low <- reclass_risk_mangroves==1
plot(risk_mangroves_low)
writeRaster(risk_mangroves_low, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025/risk_low_mangroves.tif", overwrite=TRUE)
risk_mangroves_med <- reclass_risk_mangroves==2
plot(risk_mangroves_med)
writeRaster(risk_mangroves_med, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025/risk_med_mangroves.tif", overwrite=TRUE)
risk_mangroves_hig <- reclass_risk_mangroves==3
plot(risk_mangroves_hig)
writeRaster(risk_mangroves_hig, filename="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025/risk_hig_mangroves.tif", overwrite=TRUE)
```

# F/ Habitat 2020 - Stressors 2025: Calculate the habitat area under each risk class per planning unit
...
corals_sp <- as(corals, "Spatial")
class(corals_sp)
writeOGR(obj=corals_sp, dsn="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025", layer="risk_summary_corals", driver="ESRI Shapefile", overwrite_layer =  T)
```
...
corals_risk_summary <-  rbind(corals_risk_summary,cpu_missing_w_column)
# Write the csv file
write.csv(corals_risk_summary, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025", paste("risk_summary_corals.csv")), row.names = F)
```
...
seagrass_sp <- as(seagrass, "Spatial")
class(seagrass_sp)
writeOGR(obj=seagrass_sp, dsn="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025", layer="risk_summary_seagrass", driver="ESRI Shapefile", overwrite_layer =  T)
# convert to dataframe
seagrass_risk_summary <- as.data.frame(seagrass_sp)
names(seagrass_risk_summary)
# Write the csv file
write.csv(seagrass_risk_summary, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025", paste("risk_summary_seagrass.csv")), row.names = F)
```
...
mangroves_sp <- as(mangroves, "Spatial")
class(mangroves_sp)
writeOGR(obj=mangroves_sp, dsn="E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025", layer="risk_summary_mangroves", driver="ESRI Shapefile", overwrite_layer =  T)
# convert to dataframe
mangroves_risk_summary <- as.data.frame(mangroves_sp)
names(mangroves_risk_summary)
# Write the csv file
write.csv(mangroves_risk_summary, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025", paste("risk_summary_mangroves.csv")), row.names = F)
```
...
cor_risk_2016 <- read.csv("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016/risk_summary_corals.csv") 
cor_risk_2016_km2 <- cor_risk_2016[,c(1:9)]
cor_risk_2016_pct <- cor_risk_2016[,c(1:5,10:13)]
cor_risk_2020 <- read.csv("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020/risk_summary_corals.csv") 
cor_risk_2020_km2 <- cor_risk_2020[,c(1:9)]
cor_risk_2020_pct <- cor_risk_2020[,c(1:5,10:13)]
cor_risk_2025 <- read.csv("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025/risk_summary_corals.csv")
...
names(cor_risk_all)  
write.csv(cor_risk_all, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("risk_km2_by_scenario_corals.csv")), row.names = F)
```
...
write.csv(cor_risk_all, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("risk_pct_by_scenario_corals.csv")), row.names = F)
```
...
sgr_risk_2016 <- read.csv("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016/risk_summary_seagrass.csv") 
sgr_risk_2016_km2 <- sgr_risk_2016[,c(1:9)]
sgr_risk_2016_pct <- sgr_risk_2016[,c(1:5,10:13)]
sgr_risk_2020 <- read.csv("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020/risk_summary_seagrass.csv") 
sgr_risk_2020_km2 <- sgr_risk_2020[,c(1:9)]
sgr_risk_2020_pct <- sgr_risk_2020[,c(1:5,10:13)]
sgr_risk_2025 <- read.csv("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025/risk_summary_seagrass.csv")
...
write.csv(sgr_risk_all, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("risk_km2_by_scenario_seagrass.csv")), row.names = F)
```
...
sgr_risk_all <- rbind(msgr_risk_2016, msgr_risk_2020, msgr_risk_2025) 
names(sgr_risk_all) # Write the csv file 
write.csv(sgr_risk_all, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("risk_pct_by_scenario_seagrass.csv")), row.names = F)
```
...
mgv_risk_2016 <- read.csv("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2016/risk_summary_mangroves.csv") 
mgv_risk_2016_km2 <- mgv_risk_2016[,c(1:9)]
mgv_risk_2016_pct <- mgv_risk_2016[,c(1:5,10:13)]
mgv_risk_2020 <- read.csv("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2020/risk_summary_mangroves.csv") 
mgv_risk_2020_km2 <- mgv_risk_2020[,c(1:9)]
mgv_risk_2020_pct <- mgv_risk_2020[,c(1:5,10:13)]
mgv_risk_2025 <- read.csv("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/2025/risk_summary_mangroves.csv")
...
write.csv(mgv_risk_all, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("risk_km2_by_scenario_mangroves.csv")), row.names = F)
```
...
mgv_risk_all <- rbind(mmgv_risk_2016, mmgv_risk_2020, mmgv_risk_2025) 
names(mgv_risk_all) # Write the csv file 
write.csv(mgv_risk_all, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("risk_pct_by_scenario_mangroves.csv")), row.names = F)
```
...
risk_df <- read.csv("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/risk_km2_by_scenario_corals.csv")
risk_df$cpu <- as.factor(risk_df$cpu)
# select rows 10 = BZ 
target <- c('10')
bz_df <- risk_df[risk_df$cpu %in% target,] 
write.csv(bz_df, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("risk_km2_by_scenario_corals_bz.csv")), row.names = F)
```

```{r Belize results for Coral in pct}
risk_df <- read.csv("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/risk_pct_by_scenario_corals.csv")
risk_df$cpu <- as.factor(risk_df$cpu)
# select rows 10 = BZ 
target <- c('10')
bz_df <- risk_df[risk_df$cpu %in% target,] 
write.csv(bz_df, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("risk_pct_by_scenario_corals_bz.csv")), row.names = F)
```

```{r Belize results for Seagrass in km2}
risk_df <- read.csv("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/risk_km2_by_scenario_seagrass.csv")
risk_df$cpu <- as.factor(risk_df$cpu)
# select rows 10 = BZ 
target <- c('10')
bz_df <- risk_df[risk_df$cpu %in% target,] 
write.csv(bz_df, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("risk_km2_by_scenario_seagrass_bz.csv")), row.names = F)
```

```{r Belize results for Seagrass in pct}
risk_df <- read.csv("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/risk_pct_by_scenario_seagrass.csv")
risk_df$cpu <- as.factor(risk_df$cpu)
# select rows 10 = BZ 
target <- c('10')
bz_df <- risk_df[risk_df$cpu %in% target,] 
write.csv(bz_df, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("risk_pct_by_scenario_seagrass_bz.csv")), row.names = F)
```

```{r Belize results for Mangroves in km2}
risk_df <- read.csv("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/risk_km2_by_scenario_mangroves.csv")
risk_df$cpu <- as.factor(risk_df$cpu)
# select rows 10 = BZ 
target <- c('10')
bz_df <- risk_df[risk_df$cpu %in% target,] 
write.csv(bz_df, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("risk_km2_by_scenario_mangroves_bz.csv")), row.names = F)
```

```{r Belize results for Mangroves in pct}
risk_df <- read.csv("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/risk_pct_by_scenario_mangroves.csv")
risk_df$cpu <- as.factor(risk_df$cpu)
# select rows 10 = BZ 
target <- c('10')
bz_df <- risk_df[risk_df$cpu %in% target,] 
write.csv(bz_df, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("risk_pct_by_scenario_mangroves_bz.csv")), row.names = F)
```
...
write.csv(bz_df, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("risk_km2_by_scenario_corals_cpu.csv")), row.names = F)
```
...
bz_df$CPU <- paste(bz_df$cpu,bz_df$cpu_name,sep= "-")
bz_df <- bz_df[, c(1:2,8,3:7)]
write.csv(bz_df, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("risk_pct_by_scenario_corals_cpu.csv")), row.names = F)
```
...
bz_df$CPU <- paste(bz_df$cpu,bz_df$cpu_name,sep= "-")
bz_df <- bz_df[, c(1:2,8,3:7)]
write.csv(bz_df, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("risk_km2_by_scenario_seagrass_cpu.csv")), row.names = F)
```
...
bz_df$CPU <- paste(bz_df$cpu,bz_df$cpu_name,sep= "-")
bz_df <- bz_df[, c(1:2,8,3:7)]
write.csv(bz_df, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("risk_pct_by_scenario_seagrass_cpu.csv")), row.names = F)
```
...
bz_df$CPU <- paste(bz_df$cpu,bz_df$cpu_name,sep= "-")
bz_df <- bz_df[, c(1:2,8,3:7)]
write.csv(bz_df, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("risk_km2_by_scenario_mangroves_cpu.csv")), row.names = F)
```
...
bz_df$CPU <- paste(bz_df$cpu,bz_df$cpu_name,sep= "-")
bz_df <- bz_df[, c(1:2,8,3:7)]
write.csv(bz_df, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("risk_pct_by_scenario_mangroves_cpu.csv")), row.names = F)
```
...
habitat_risk <- read.csv("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/risk_km2_by_scenario_corals_bz.csv")
...
write.csv(functional_hab_sum, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("functional_habitat_km2_by_scenario_corals_bz.csv")), row.names = F)
```

```{r Calculate functional habitat for Seagrass}
habitat_risk <- read.csv("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/risk_km2_by_scenario_seagrass_bz.csv")
habitat_risk$Risk <- as.factor(habitat_risk$Risk)
target <- c('No Risk','Low') 
risk_low <- habitat_risk[habitat_risk$Risk %in% target,] 
risk_low$func_hab = risk_low$km2*1
...
write.csv(functional_hab_sum, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("functional_habitat_km2_by_scenario_seagrass_bz.csv")), row.names = F)
```

```{r Calculate functional habitat for Mangroves}
habitat_risk <- read.csv("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/risk_km2_by_scenario_mangroves_bz.csv")
habitat_risk$Risk <- as.factor(habitat_risk$Risk)
target <- c('No Risk','Low') 
risk_low <- habitat_risk[habitat_risk$Risk %in% target,] 
risk_low$func_hab = risk_low$km2*1
...
write.csv(functional_hab_sum, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("functional_habitat_km2_by_scenario_mangroves_bz.csv")), row.names = F)
```
...
write.csv(functional_hab_sum_bz, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("functional_habitat_km2_by_scenario_bz.csv")), row.names = F)
```
...
```{r Calculate functional habitat for Coral}
habitat_risk <- read.csv("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/risk_km2_by_scenario_corals_cpu.csv")
habitat_risk$Risk <- as.factor(habitat_risk$Risk)
target <- c('No Risk','Low') 
risk_low <- habitat_risk[habitat_risk$Risk %in% target,] 
risk_low$func_hab = risk_low$km2*1
...
functional_hab_sum -> functional_hab_sum_coral
write.csv(functional_hab_sum, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("functional_habitat_km2_by_scenario_corals_cpu.csv")), row.names = F)
```

```{r Calculate functional habitat for Seagrass}
habitat_risk <- read.csv("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/risk_km2_by_scenario_seagrass_cpu.csv")
habitat_risk$Risk <- as.factor(habitat_risk$Risk)
target <- c('No Risk','Low') 
risk_low <- habitat_risk[habitat_risk$Risk %in% target,] 
...
functional_hab_sum <- functional_hab %>% group_by(Year,cpu,CPU,cpu_name) %>% summarise(km2 = sum(func_hab))
functional_hab_sum -> functional_hab_sum_seagrass
write.csv(functional_hab_sum, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("functional_habitat_km2_by_scenario_seagrass_cpu.csv")), row.names = F)
```

```{r Calculate functional habitat for Mangroves}
habitat_risk <- read.csv("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats/risk_km2_by_scenario_mangroves_cpu.csv")
habitat_risk$Risk <- as.factor(habitat_risk$Risk)
target <- c('No Risk','Low') 
risk_low <- habitat_risk[habitat_risk$Risk %in% target,] 
risk_low$func_hab = risk_low$km2
...
functional_hab_sum <- functional_hab %>% group_by(Year,cpu,CPU,cpu_name) %>% summarise(km2 = sum(func_hab))
functional_hab_sum -> functional_hab_sum_mangroves
write.csv(functional_hab_sum, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("functional_habitat_km2_by_scenario_mangroves_cpu.csv")), row.names = F)
```

Last we combine the functional habitat for each habitat into one database to create a barchart Refer to HRA_figure script)
```{r Combine the functional habitat for the 3 habitats into 1 database}
functional_hab_sum_coral$Habitat <- "Corals" 
functional_hab_sum_seagrass$Habitat <- "Seagrasses"
functional_hab_sum_mangroves$Habitat <- "Mangroves"
...
write.csv(functional_hab_sum_cpu, file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("functional_habitat_km2_by_scenario_cpu.csv")), row.names = F)
```
...
setwd("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats")
...
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_1_barplot_bz_hab_risk_corals.pdf")),
    width = 6, height = 5)
plot_grid(ggbars + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_blank(), 
        ...
        legend.position="bottom")
plot_grid(ggbars + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_2_barplot_bz_hab_risk_seagrass.pdf")),
    width = 6, height = 5)
plot_grid(ggbars + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_blank(), 
        ...
        legend.position="bottom")
plot_grid(ggbars + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_3_barplot_bz_hab_risk_mangroves.pdf")),
    width = 6, height = 5)
plot_grid(ggbars + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_4_barplot_cpu_hab_risk_corals.pdf")),
    width = 8, height = 5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_4_barplot_cpu_hab_risk_corals_1.pdf")),
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_4_barplot_cpu_hab_risk_corals_2.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_4_barplot_cpu_hab_risk_corals_3.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_4_barplot_cpu_hab_risk_corals_4.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_4_barplot_cpu_hab_risk_corals_5.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_4_barplot_cpu_hab_risk_corals_6.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_4_barplot_cpu_hab_risk_corals_7.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_4_barplot_cpu_hab_risk_corals_8.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_4_barplot_cpu_hab_risk_corals_9.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_5_barplot_cpu_hab_risk_seagrass.pdf")),
    width = 8, height = 5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_5_barplot_cpu_hab_risk_seagrass_1.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_5_barplot_cpu_hab_risk_seagrass_2.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_5_barplot_cpu_hab_risk_seagrass_3.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_5_barplot_cpu_hab_risk_seagrass_4.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_5_barplot_cpu_hab_risk_seagrass_5.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_5_barplot_cpu_hab_risk_seagrass_6.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_5_barplot_cpu_hab_risk_seagrass_7.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_5_barplot_cpu_hab_risk_seagrass_8.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_5_barplot_cpu_hab_risk_seagrass_9.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_6_barplot_cpu_hab_risk_mangroves.pdf")),
    width = 8, height = 5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_6_barplot_cpu_hab_risk_mangroves_1.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_6_barplot_cpu_hab_risk_mangroves_2.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_6_barplot_cpu_hab_risk_mangroves_3.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_6_barplot_cpu_hab_risk_mangroves_4.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_6_barplot_cpu_hab_risk_mangroves_5.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_6_barplot_cpu_hab_risk_mangroves_6.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_6_barplot_cpu_hab_risk_mangroves_7.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_6_barplot_cpu_hab_risk_mangroves_8.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_risk) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_6_barplot_cpu_hab_risk_mangroves_9.pdf")),
    width = 8.5, height = 2.5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_functional) +
  ...
  theme(axis.title.x = element_blank(), 
        ...
        legend.position="bottom")
plot_grid(ggbars + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_7_barplot_bz_hab_functional.pdf")),
    width = 5, height = 4.5)
plot_grid(ggbars + scale_y_continuous(labels = scales::comma))
dev.off()
```
...
ggbars <- ggplot(hab_functional) +
  ...
  theme(axis.title.x = element_text(size = 12, face="bold"), 
        ...
        legend.position="bottom")
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
pdf(file.path("E:/GreenFin/01_hra_model/5_hra_outputs/2020_habitats", paste("Fig_8_barplot_cpu_hab_functional.pdf")),
    width = 8, height = 5)
plot_grid(ggbars + coord_flip() + scale_y_continuous(labels = scales::comma))
dev.off()
```
